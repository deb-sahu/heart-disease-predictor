...
from src.config import ALL_FEATURES, NUMERIC_FEATURES, PIPELINE_PATH
...
class HeartDiseasePredictor:
    ...
    def predict_batch(self, data: pd.DataFrame) -> pd.DataFrame:
        ...
        result_df["prediction_label"] = result_df["prediction"].map({0: "No Heart Disease", 1: "Heart Disease Present"})
