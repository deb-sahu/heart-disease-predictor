...
from src.config import CATEGORICAL_FEATURES, NUMERIC_FEATURES, PREPROCESSOR_PATH, TARGET_COLUMN
...
def preprocess_data(
    df: pd.DataFrame, fit: bool = True, preprocessor: Optional[ColumnTransformer] = None
